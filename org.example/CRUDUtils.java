...
public class CRUDUtils {
    ...
    public static List<Student> updateStudentData(int studentId, String curse_name) {
        List<Student> updateStudents = new ArrayList<>();

        try(Connection connection = DBUtils.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(UPDATE_STUDENT)) {
            preparedStatement.setString(1,curse_name);
            ...
            while (resultSet.next()) {
                ...
                updateStudents.add(new Student(id,name,surname,curs_name));
            }
    ...
    public static void deleteStudentData(int studentId) {

        try(Connection connection = DBUtils.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(DELETE_STUDENT)) {
